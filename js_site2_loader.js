    ...
    switch (type)
    {
      case 'book':
        if (anchor['prev'])
        {
          ...
          ul.append($('<li>').append($('<a>').text('‘O‚Ö').attr('href', p)));
        }
        if (anchor['next'])
        {
          var p = anchor['next'].match(/^:/) ? '?p=' + anchor['next'].substr(1) : anchor['next'];
          ul.append($('<li>').append($('<a>').text('ŽŸ‚Ö').attr('href', p)));
        }
        break;
      case 'list':
        if (anchor['list'])
        {
          ...
          if (0 < i) ul.append($('<li>').append($('<a>').text('‘O‚Ö').attr('href', '?p=' + anchor['list'][i -1])));
          if (i +1 < anchor['list'].length) ul.append($('<li>').append($('<a>').text('ŽŸ‚Ö').attr('href', '?p=' + anchor['list'][i +1])));
        }
        break;
    }
